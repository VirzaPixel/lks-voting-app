                ...
                while (true)
                {
                    ...
                    if (json != null)
                    {
                        ...
                        if (!pgsql.State.Equals(System.Data.ConnectionState.Open))
                        {
                            ...
                            // edit
                            pgsql = OpenDbConnection("Server=lks-rds.cunsvijdc0h4.us-east-1.rds.amazonaws.com;Username=admin123;Password=LKSNCC2024;Database=postgres;SSL Mode=Require;Trust Server Certificate=true;");
                        }
                        else
